...
export const conclusion = {
  ...
  challenge: {
    label: "Thách thức & Điểm đắc nhất",
    challengeText:
      "Thách thức: Việc cá nhân hóa các sản phẩm công nghệ sao cho vẫn giữ được sự nghiêm túc của ngành Luật.",
    highlightText:
      "Điểm đắc nhất: Mình đã tạo ra được một hồ sơ số chuyên nghiệp, nơi mình tự hào giới thiệu bản thân với nhà tuyển dụng trong tương lai.",
  },
};
