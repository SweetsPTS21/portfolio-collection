    ...
    <div className="cloud-card pdf-viewer-card">
      ...
      <div style={{ flexGrow: 1, display: "flex", flexDirection: "column" }}>
        <object
          ...
          width="100%"
          height="550px"
          style={{ border: "1px solid rgba(137, 207, 240, 0.2)", borderRadius: "12px" }}
        >
          ...
          <div className="pdf-fallback-container">
            ...
            <div>
              ...
              <p style={{ color: "var(--deep-navy)", opacity: 0.8, fontSize: "0.9rem", marginBottom: "16px" }}>
                Trình duyệt của bạn không hỗ trợ hiển thị file PDF trực tiếp. Hãy click nút bên dưới để xem hoặc tải xuống bài tập của mình nhé!
              </p>
              <a
                href={pdfUrl}
                target="_blank"
