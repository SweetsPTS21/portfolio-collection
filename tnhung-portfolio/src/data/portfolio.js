...
export const person = {
  ...
  intro:
    'Em yêu sự tinh tế trong cách trình bày, sự mềm mại trong ngôn ngữ và chiều sâu trong tư duy. Định hướng của em là trở thành một chuyên gia pháp lý không chỉ vững vàng về chuyên môn mà còn thấu hiểu sâu sắc các giá trị nhân văn.',
  technologyView:
    'Đối với em, công nghệ không chỉ là những dòng dữ liệu vô cảm, mà còn là một không gian để con người thể hiện bản sắc, cảm xúc và giá trị riêng của mình. Em ứng dụng công nghệ để làm cho quá trình nghiên cứu trở nên thanh thoát và hiệu quả hơn, từ đó dành trọn tâm trí cho việc đào sâu các vấn đề pháp lý phức tạp.',
  portfolioGoal:
  ...
  homeStoryCards: [
    ...
    {
      title: 'Công nghệ như không gian biểu đạt',
      content:
    ...
    },
    {
      ...
      content:
        'Ứng dụng công nghệ để quá trình nghiên cứu thanh thoát, hiệu quả và có thêm không gian cho tư duy pháp lý.',
    },
    {
...
export const projects = [
  {
    ...
    goal:
      'Rèn luyện thao tác quản lý tệp tin, xây dựng không gian lưu trữ tài liệu học thuật đề cao tính logic và sự tinh tế.',
    process:
    ...
    beats: [
      {
        label: 'Mục tiêu',
        text:
          'Rèn luyện thao tác quản lý tệp tin và xây dựng không gian lưu trữ học thuật có logic.',
      },
      {
        label: 'Thao tác',
        text:
          'Thực hành tuần tự các lệnh tạo mới, đổi tên, sao chép và phân loại thư mục.',
      },
      {
        label: 'Sắp xếp',
        text:
          'Từ dữ liệu ban đầu, sắp xếp văn bản học tập thành một hệ thống phân tầng mạch lạc.',
      },
      {
        label: 'Kết quả',
        text:
          'Không gian làm việc số trở nên thanh thoát, việc tìm giáo trình Luật diễn ra êm ái hơn.',
      },
    ],
    color: '#c084fc',
    pdf: bt1Pdf,
  },
  {
    ...
    goal:
      'Vận dụng tư duy sắc sảo để tra cứu, thu thập và đánh giá độ tin cậy của các nguồn học liệu pháp lý.',
    process:
    ...
    beats: [
      {
        label: 'Mục tiêu',
        text:
          'Tra cứu, thu thập và đánh giá độ tin cậy của các nguồn học liệu pháp lý.',
      },
      {
        label: 'Nguồn tìm kiếm',
        text:
          'Tìm hơn 10 tài liệu chuyên sâu qua Google Scholar và cơ sở dữ liệu thư viện.',
      },
      {
        label: 'Thẩm định',
        text:
          'Đánh giá từng bài báo theo uy tín tác giả và tính cập nhật trước khi tổng hợp.',
      },
      {
        label: 'Chuẩn học thuật',
        text:
          'Lập bảng tổng hợp và trích dẫn theo chuẩn Harvard để giữ chiều sâu nghiên cứu.',
      },
    ],
    color: '#f472b6',
    pdf: bt2Pdf,
  },
  {
    ...
    goal:
      'Phát triển kỹ năng giao tiếp với nền tảng trí tuệ nhân tạo thông qua việc xây dựng và tối ưu hóa các câu lệnh truy vấn (prompts).',
    process:
    ...
    beats: [
      {
        label: 'Mục tiêu',
        text:
          'Phát triển kỹ năng giao tiếp với AI qua xây dựng và tối ưu hóa prompt.',
      },
      {
        label: 'Thử nghiệm',
        text:
          'Chọn các tác vụ học tập quen thuộc và tạo câu lệnh từ cơ bản đến nâng cao.',
      },
      {
        label: 'So sánh',
        text:
          'Phân tích kết quả để thấy AI hữu ích nhất khi được dẫn dắt bằng tư duy logic.',
      },
      {
        label: 'Đúc kết',
        text:
          'Tự rút ra nguyên tắc riêng để làm chủ công cụ này một cách hiệu quả.',
      },
    ],
    color: '#818cf8',
    pdf: bt3Pdf,
  },
  {
    ...
    goal:
      'Tổ chức một cuộc họp trực tuyến chuyên nghiệp, đề cao sự tôn trọng, nhã nhặn và hiệu quả làm việc nhóm.',
    process:
    ...
    beats: [
      {
        label: 'Mục tiêu',
        text:
          'Tổ chức một cuộc họp trực tuyến chuyên nghiệp, nhã nhặn và hiệu quả.',
      },
      {
        label: 'Chuẩn bị',
        text:
          'Lên chương trình nghị sự và phân công rõ vai trò điều phối, thư ký ghi chép.',
      },
      {
        label: 'Trao đổi',
        text:
          'Giữ không khí nhẹ nhàng nhưng luôn đi đúng trọng tâm chuyên môn.',
      },
      {
        label: 'Minh chứng',
        text:
          'Biên bản cuối cùng được tổng hợp cẩn thận, thể hiện sự văn minh và gắn kết.',
      },
    ],
    color: '#fb7185',
    pdf: bt4Pdf,
  },
  {
    ...
    goal:
      'Ứng dụng các công cụ tạo sinh để thổi hồn thẩm mỹ vào những sản phẩm truyền thông học thuật.',
    process:
    ...
    beats: [
      {
        label: 'Mục tiêu',
        text:
          'Ứng dụng công cụ tạo sinh để thổi hồn thẩm mỹ vào sản phẩm truyền thông học thuật.',
      },
      {
        label: 'Kết hợp',
        text:
          'Dùng nền tảng tạo văn bản cùng công cụ thiết kế hình ảnh để dựng sản phẩm trực quan.',
      },
      {
        label: 'Vai trò của AI',
        text:
          'Máy móc hỗ trợ phác thảo ý tưởng và tạo khung sườn ban đầu.',
      },
      {
        label: 'Dấu ấn cá nhân',
        text:
          'Tự tinh chỉnh câu chữ và bố cục để giữ nét dịu dàng, tinh tế của riêng mình.',
      },
    ],
    color: '#fbbf24',
    pdf: bt5Pdf,
  },
  {
    ...
    goal:
      'Xác lập ranh giới đạo đức, xây dựng bộ nguyên tắc cá nhân khi ứng dụng công nghệ vào môi trường đại học.',
    process:
      'Sau khi nghiên cứu kỹ quy định của Đại học Luật, mình đã tự tay thiết kế một bản đồ học thông tin vô cùng trực quan. Trong đó, mình đặt ra nguyên tắc minh bạch tuyệt đối: trân trọng chất xám nguyên bản, khai báo rõ ràng phần hỗ trợ từ công nghệ và luôn bảo vệ chiều sâu tư duy độc lập của bản thân trước mọi dữ liệu tự động.',
    product: 'docs/Bt6.pdf',
    beats: [
      {
        label: 'Mục tiêu',
        text:
          'Xác lập ranh giới đạo đức khi ứng dụng công nghệ trong môi trường đại học.',
      },
      {
        label: 'Nền tảng',
        text:
          'Nghiên cứu kỹ quy định của Đại học Luật trước khi xây dựng nguyên tắc cá nhân.',
      },
      {
        label: 'Sản phẩm',
        text:
          'Thiết kế một bản đồ học thông tin trực quan về an toàn số và liêm chính học thuật.',
      },
      {
        label: 'Nguyên tắc',
        text:
          'Minh bạch hỗ trợ từ công nghệ, trân trọng chất xám nguyên bản và bảo vệ tư duy độc lập.',
      },
    ],
    color: '#34d399',
    pdf: bt6Pdf,
...
export const projectionsIntro =
  'Dưới đây là hai thông điệp cốt lõi định hình tư duy của em xuyên suốt quá trình tiếp cận công nghệ số và trí tuệ nhân tạo:';
...
export const projections = [
  {
    ...
    label: 'Thẻ Nhìn nhận',
    content:
      'Em không muốn AI suy nghĩ thay mình. Em muốn học cách đối thoại với nó bằng tư duy của chính mình.',
  },
  {
    type: 'CONCLUSION',
    label: 'Thẻ Kết luận',
    content:
      'Trong thời đại AI, điều quan trọng nhất không phải là sử dụng công nghệ, mà là làm chủ tư duy của chính mình.',
  },
];

export const conclusion = {
  summary:
    'Quá trình thực hiện portfolio và học tập môn Nhập môn Công nghệ số & Ứng dụng AI đã giúp em thay đổi rất nhiều trong cách nhìn về công nghệ. Trước đây, em từng nghĩ máy tính hay Internet chỉ là những công cụ hỗ trợ học tập thông thường. Nhưng sau hành trình này, em hiểu rằng công nghệ có thể trở thành một không gian học thuật mở – nơi con người lưu trữ tri thức, kết nối ý tưởng và phát triển tư duy theo những cách hoàn toàn mới. Điều quan trọng nhất em học được không phải là cách sử dụng thật nhiều công cụ số, mà là học cách giữ được sự tỉnh táo giữa một thế giới có quá nhiều dữ liệu và quá nhiều câu trả lời được tạo ra bởi AI.',
  summaryParts: [
    'Quá trình thực hiện portfolio và học tập môn Nhập môn Công nghệ số & Ứng dụng AI đã giúp em thay đổi rất nhiều trong cách nhìn về công nghệ.',
    'Trước đây, em từng nghĩ máy tính hay Internet chỉ là những công cụ hỗ trợ học tập thông thường.',
    'Sau hành trình này, em hiểu rằng công nghệ có thể trở thành một không gian học thuật mở.',
  ...
  coreSkills: [
    {
      ...
      desc:
        'Em trở nên cẩn trọng hơn trong việc kiểm tra nguồn dữ liệu, đánh giá lập luận và nhìn nhận thông tin dưới nhiều góc độ khác nhau.',
    },
    {
      title: 'Kỹ năng sử dụng AI tạo sinh',
      desc:
        'Em học được cách đặt prompt rõ ràng, định hướng AI đi đúng trọng tâm và loại bỏ những nội dung khuôn mẫu để phục vụ việc học tập hiệu quả hơn.',
    },
    {
      title: 'Kỹ năng trình bày và tổ chức nội dung',
      desc:
        'Em biết cách xây dựng bố cục website mạch lạc, tối ưu trải nghiệm người xem và biến một bài tập học thuật thành một không gian thể hiện dấu ấn cá nhân.',
    },
  ],
  highlightLabel: 'Điều em tâm đắc nhất:',
  highlight:
    'Sau hành trình này, điều em nhận ra là công nghệ có thể hỗ trợ con người tiếp cận tri thức nhanh hơn, nhưng không thể thay thế khả năng tư duy độc lập, phản biện và chiều sâu trong cách nhìn nhận vấn đề. Với em, giá trị lớn nhất của việc học không nằm ở việc sử dụng được bao nhiêu công cụ, mà nằm ở việc vẫn giữ được tiếng nói học thuật và góc nhìn riêng của mình giữa một thế giới ngày càng nhiều nội dung được tạo ra bởi AI.',
  highlightParts: [
  ...
  direction:
    'Trong tương lai, em mong muốn tiếp tục phát triển portfolio theo hướng chuyên nghiệp và mang tính cá nhân sâu sắc hơn: tối ưu trải nghiệm người xem bằng phong cách tối giản, tinh tế, kết hợp công nghệ với tư duy học thuật chuyên sâu, và ứng dụng AI vào nghiên cứu pháp lý theo hướng có trách nhiệm, nhân văn và hiệu quả.',
  directionParts: [
    'Phát triển portfolio theo hướng chuyên nghiệp và mang tính cá nhân sâu sắc hơn.',
    'Tối ưu trải nghiệm người xem bằng phong cách tối giản, tinh tế.',
