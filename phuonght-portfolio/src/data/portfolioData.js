...
export const profile = {
  ...
  studentId: '24062033',
  quote:
    'Chào mừng các bạn đến với góc học tập kỹ thuật số của em. Em muốn không gian này giống như một thước phim, ghi lại quá trình em làm quen và ứng dụng công nghệ vào chuyên ngành Luật.',
  intro:
    'Chương trình Luật chất lượng cao đòi hỏi nền tảng kiến thức vững chắc và tư duy phân tích chiều sâu. Định hướng của em là trở thành một người làm nghề luật điềm đạm, xử lý công việc bằng sự thấu hiểu và cẩn trọng. Em sử dụng công nghệ như một người trợ lý thầm lặng giúp dọn dẹp, sắp xếp khối lượng tài liệu khổng lồ. Nhờ đó, em có được sự tĩnh tại cần thiết để đào sâu vào các vấn đề pháp lý phức tạp.',
  hobbies: ['Nghe nhạc', 'Xem phim', 'Nấu ăn'],
  style: ['Nhẹ nhàng', 'Sâu lắng', 'Cẩn thận'],
  mindset:
    'Em tìm thấy sự bình yên qua việc nghe nhạc, xem phim và đặc biệt thích nấu ăn để tự tay chăm sóc bản thân cũng như những người xung quanh. Em thích làm việc một cách từ tốn, cẩn thận, luôn lắng nghe và quan sát để hiểu thấu đáo bản chất của vấn đề thay vì vội vàng đánh giá bề ngoài.',
};
...
export const projects = [
  {
    ...
    process:
      'Em sắp xếp dữ liệu trên máy tính giống như cách mình chuẩn bị nguyên liệu trước khi nấu ăn, mọi thứ phải thật ngăn nắp và đúng vị trí. Em tạo thư mục gốc mang tên mình, sau đó phân chia thành các thư mục con theo từng môn học chuyên ngành. Các thao tác đổi tên tệp, sao chép và di chuyển được thực hiện đồng bộ. Những dữ liệu nháp được dọn sạch vào thùng rác. Nhờ vậy, không gian làm việc luôn gọn gàng, giúp em dễ dàng tìm lại tài liệu khi cần.',
    pdf: '/Bt1.pdf',
    pdfName: 'Bt1.pdf',
    icon: 'FolderOpen',
    colorClass: 'mint',
  },
  {
    ...
    process:
      'Em sử dụng từ khóa chuyên môn kết hợp bộ lọc nâng cao để tìm kiếm tài liệu từ các tạp chí khoa học chuyên ngành. Em đã tập hợp 10 nguồn tài liệu tham khảo, trong đó có 5 bài báo khoa học chất lượng. Từng nguồn đều được kiểm chứng cẩn thận về uy tín tác giả và lập thành bảng đánh giá chi tiết.',
    pdf: '/Bt2.pdf',
    pdfName: 'Bt2.pdf',
    icon: 'Search',
    colorClass: 'blue',
...
export const conclusion = {
  ...
  acknowledgements:
    'Em xin gửi lời cảm ơn đến các thầy cô đã hướng dẫn tận tình, giúp sinh viên làm chủ các kỹ năng số cần thiết. Cảm ơn các bạn trong nhóm 29 đã phối hợp ăn ý, thông cảm và cùng nhau hoàn thành tốt công việc chung. Cảm ơn người đọc vì đã dành thời gian theo dõi Portfolio của em.',
};
