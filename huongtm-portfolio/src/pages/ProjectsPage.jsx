    ...
    <PageTransition>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p
            style={{
              color: 'var(--huong-text-muted)',
              fontSize: '1.05rem',
              maxWidth: '600px',
              margin: '0 auto',
            }}
          >
            Từng bài tập đều được thực hiện cẩn trọng, đi thẳng vào trọng tâm và
            thể hiện tư duy độc lập của mình.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{
                      borderLeft: '3px solid var(--huong-pink-soft)',
                      paddingLeft: '12px',
                      marginTop: '8px',
                    }}
                  >
