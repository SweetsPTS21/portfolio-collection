...
export const vision = {
  ...
  content: [
    'Điện ảnh cho tôi thế giới quan đa chiều, việc khám phá thế giới cho tôi tư duy mở, và ngành Luật rèn luyện cho em sự duy lý.',
...
export const projects = {
  ...
  items: [
    ...
    },
    {
      ...
      content:
        'Tiếp cận khái niệm, xu hướng và giới hạn của AI hiện đại.',
      process:
