...
export const philosophy = {
  title: 'Triết lý học tập & định hướng số',
  body:
    'Đối với mình, công nghệ không phải là sự nhồi nhét hay chạy đua. Công nghệ là nghệ thuật tối giản hóa cuộc sống. Là một sinh viên Luật, mình hướng tới việc sử dụng công cụ số và AI để dọn dẹp những tiếng ồn thông tin, tinh lọc những giá trị cốt lõi, từ đó để dành không gian cho sự sáng tạo, lãng mạn và những suy nghiệm sâu sắc về công lý và con người.',
};
...
export const reflections = [
  {
    title: 'Chất riêng',
    body:
      'Portfolio giữ tinh thần không phô trương, không nhồi nhét, mọi thứ vừa đủ, thanh lịch và tĩnh lặng như một trang sách được sắp đặt cẩn thận.',
  },
  {
    title: 'Kỹ năng quý nhất',
    body:
      'Mình học được sự chậm rãi có chủ đích: biết dừng lại để kiểm chứng thông tin thật/giả giữa kỷ nguyên mạng vội vã.',
  },
  {
    title: 'Điểm tâm đắc',
    body:
      'Phần Chương 6 thể hiện sự độc lập trong tư duy, không chạy theo công nghệ một cách mù quáng mà đặt chất lượng học thuật lên trước.',
  },
  {
    title: 'Định vị AI',
    body:
      'AI chỉ là người bạn đồng hành, hỗ trợ tiến độ công việc; con người mới là người hoàn thành, quyết định kết quả và điều phối AI đi đúng hướng.',
  },
];
