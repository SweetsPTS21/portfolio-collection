      ...
      <div className="lg:col-span-8 space-y-8">
            ...
            {personalInfo.hobbies.map((hobby, index) => {
              ...
              return (
                ...
                >
                  ...
                  <strong className="text-sm text-[#3A5A40] font-bold block">
                    {hobby.label}
                  </strong>
                  <span className="text-xs text-[#588157] mt-1 leading-snug">
                    {hobby.desc}
                  </span>
                </motion.div>
              );
        ...
        <motion.div variants={itemVariants}>
          <PulpCard className="bg-[#DAD7CD]/40">
            <h4 className="text-lg font-bold text-[#3A5A40] mb-4">
              Các Công Cụ Đã Trải Nghiệm
            </h4>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {personalInfo.tools.map((tool, index) => (
                <div
                  key={index}
                  className="p-3 rounded-[12px] bg-[#F5F5F5]/60 border border-[#A3B18A]/30 text-center hover:bg-[#F5F5F5]/90 transition-colors"
                >
                  <strong className="text-xs text-[#3A5A40] font-bold block">
                    {tool.name}
                  </strong>
                  <span className="text-[10px] text-[#588157] block mt-1 leading-snug">
                    {tool.desc}
                  </span>
                </div>
              ))}
