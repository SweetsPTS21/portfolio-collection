  ...
  return (
    <article className="route-page projects-page">
      <motion.header className="station-heading" variants={stationDrop} initial="hidden" animate="visible">
        <span className="station-kicker">II. Trang Dự án (Projects)</span>
        <h1>Trang Dự án</h1>
        <p>Dưới đây là các sản phẩm thực hành được em hoàn thiện một cách chỉn chu, đi thẳng vào trọng tâm chuyên môn và bám sát yêu cầu từ môn học.</p>
      </motion.header>
      <StationProjectGrid />
    </article>
  );
