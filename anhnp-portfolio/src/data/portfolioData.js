...
export const focalAssetsByRoute = {
  '/about': [
    { id: 'moon', file: 'lavender-moon-scene.svg', label: 'Trăng lavender', kind: 'large-focal', desktopVw: 42, mobileVw: 72 },
    { id: 'notebook', file: 'giant-glass-notebook.svg', label: 'Sổ tay kính', kind: 'large-focal', desktopVw: 34, mobileVw: 62 },
  ],
  '/projects': [
    { id: 'folder', file: 'dream-folder-landscape.svg', label: 'Folder pastel lớn', kind: 'large-focal', desktopVw: 58, mobileVw: 88 },
    { id: 'papers', file: 'floating-study-papers.svg', label: 'Cụm giấy học tập', kind: 'large-focal', desktopVw: 30, mobileVw: 58 },
  ],
  '/conclusion': [
    { id: 'window', file: 'constellation-dream-window.svg', label: 'Cửa sổ chòm sao', kind: 'large-focal', desktopVw: 52, mobileVw: 86 },
    { id: 'gate', file: 'thank-you-moon-gate.svg', label: 'Cổng trăng cảm ơn', kind: 'large-focal', desktopVw: 44, mobileVw: 76 },
  ],
};
...
export const profile = {
  ...
  greeting: 'Chào mọi người, em là Nguyễn Phương Anh. Chào mừng mọi người đến với trang portfolio cá nhân của em.',
  interests: ['Nghe nhạc để thư giãn', 'Xem phim để cân bằng sau giờ học', 'Quan sát và tìm hiểu bản chất vấn đề'],
  ...
  direction: 'Rèn năng lực nghiên cứu, trình bày, làm việc số và kết hợp kiến thức học tập với công nghệ trong chuyển đổi số.',
  principle: 'Không ỷ lại vào công cụ. Máy móc hỗ trợ tìm kiếm nhanh hơn, còn chắt lọc và kết luận cuối cùng đến từ tư duy độc lập.',
  tools: ['File Explorer', 'Google Drive', 'Thư viện số', 'Nguồn học thuật trực tuyến', 'Mô hình ngôn ngữ lớn', 'Google Meet', 'Canva', 'Microsoft Word'],
  avatarSpec: {
    desktopPx: 260,
    mobilePx: 220,
...
export const projectChapters = [
  {
    ...
    summary: 'Em xây hệ thống thư mục theo mã sinh viên và tên thật, tách dữ liệu theo từng chuyên đề, đặt tên đồng nhất và dọn dữ liệu thừa để truy xuất nhanh hơn.',
    card: {
  ...
  },
  {
    ...
    summary: 'Em dùng từ khóa chuyên sâu, tập hợp 10 tài liệu tham khảo, chọn 5 bài báo khoa học chất lượng và lập bảng đánh giá uy tín nguồn.',
    card: {
  ...
  },
  {
    ...
    summary: 'Em thử tóm tắt văn bản học tập, phân tích thuật ngữ và lập bộ đề ôn tập, đồng thời nhận diện giới hạn của thuật toán để giữ đánh giá độc lập.',
    card: {
  ...
  },
  {
    ...
    summary: 'Nhóm tổ chức phiên thảo luận trực tuyến về ứng dụng AI trong nghiên cứu khoa học, phân vai điều phối và thư ký rõ ràng, chia sẻ biên bản đồng bộ.',
    card: {
  ...
  },
  {
    ...
    summary: 'Em thiết kế infographic về ô nhiễm môi trường tại Hà Nội, dùng công cụ để phác thảo rồi tự chỉnh màu sắc và câu chữ để giữ thông điệp riêng.',
    card: {
  ...
  },
  {
    ...
    summary: 'Em thực hiện bài luận có lưu vết prompt, xây 7 quy tắc đạo đức cá nhân và giữ tinh thần kiểm chứng trước dữ liệu điện tử.',
    card: {
...
export const thanks = 'Em xin cảm ơn thầy cô đã hướng dẫn tận tình, cảm ơn các bạn trong nhóm đã hợp tác ăn ý và cảm ơn người đọc vì đã dành thời gian đọc portfolio của em.';
